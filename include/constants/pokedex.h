...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_CRABOMINABLE_MEGA,
...
#define FOREACH_SPECIES_IN_HOENN_DEX_ORDER(F) \
    ...
    F(ELEKID) \
    F(ELECTABUZZ) \
    HOENN_DEX_IF(P_GEN_4_CROSS_EVOS, F(ELECTIVIRE)) \
    F(CASTFORM) \
    F(BOUNSWEET) \
    F(STEENEE) \
    F(TSAREENA) \
