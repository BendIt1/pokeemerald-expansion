...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_INITIATIVEENTERS]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} has the upper hand!"),
    [STRINGID_INITIATIVEEND]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lost the upper hand!"),
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_INITIATIVE] = STRINGID_INITIATIVEENTERS,
