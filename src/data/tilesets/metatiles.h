...
const u16 gMetatiles_Icy[] = INCBIN_U16("data/tilesets/primary/icy/metatiles.bin");
const u16 gMetatileAttributes_Icy[] = INCBIN_U16("data/tilesets/primary/icy/metatile_attributes.bin");
